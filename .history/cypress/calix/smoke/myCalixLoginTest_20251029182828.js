describe('My Calix Login Test', () => {
  ...
  it('should log in with valid credentials', () => {
    ...
    cy.origin('https://calix.my.site.com', () => {
      cy.get('#sfdc_username_container > div input').type(Cypress.env('CALIX_USER_ID'));
      cy.get('#sfdc_password_container > div input').type(Cypress.env('CALIX_PASSWORD'));
    ...
    cy.get('h2').should('contain', 'Document Library');
  });
});